...
urlpatterns = [
    ...
    path('news/<slug:slug_text>/',news,name='news_ind_english'),
    path('blog/<slug:slug_text>/',blog,name='blogs_ind_english'),
    ...
    path('fhc/', fhc, name='fhc'),
    path('get-instant-business-loan/small-business/apply-now/', creditLanding, name="creditLanding"),
    path('get-instant-business-loan/small-business/apply-now/submit/', creditLandingSubmit, name="creditLandingSubmit"),
]