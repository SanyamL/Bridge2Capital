var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function (a, h, f) {
    a instanceof String && (a = String(a));
    for (var e = a.length, l = 0; l < e; l++) {
        var m = a[l];
        if (h.call(f, m, l, a)) return {
            i: l,
            v: m
        }
    }
...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (a, h, f) {
    a != Array.prototype && a != Object.prototype && (a[h] = f.value)
};
$jscomp.getGlobal = function (a) {
    return "undefined" != typeof window && window === a ? a : "undefined" != typeof global && null != global ? global : a
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function (a, h, f, e) {
    if (h) {
        f = $jscomp.global;
        a = a.split(".");
        ...
        e = f[a];
        h = h(e);
        h != e && null != h && $jscomp.defineProperty(f, a, {
            configurable: !0,
            writable: !0,
            value: h
        })
...
(function (a) {
    ...
    a.extend(a.easing, {
        easeInOutCubic: function (a,
            c, d, g, e) {
            return 1 > (c /= e / 2) ? g / 2 * c * c * c + d : g / 2 * ((c -= 2) * c * c + 2) + d
        }
    });
    ...
    a.fn.footerReveal = function () {
        function b() {
            !e && c.outerHeight() <= g.outerHeight() ? (c.css({
                "z-index": -999,
                position: "fixed",
                bottom: 0
            }), c.css({
    ...
    (function (a, c) {
        var b = function (a, b, c) {
            ...
            return function () {
                var g = this,
                    p = arguments;
                d ? clearTimeout(d) : c && a.apply(g, p);
    ...
    a(function () {
        ...
        }(a(window).width(), a(window).height()) : l || (a(window).smartresize(function () {
        ...
        a(window).scroll(function () {
            ...
            f = b;
            if (k) {
                var d = b > k.breakPoint;
                c ? d != k.fixed && (h ? (k.fixed = d, a(k.elm).toggleClass("is-fixed")) : n = setTimeout(function () {
                    k.fixed = d;
                    a(k.elm).toggleClass("is-fixed")
                }, 40)) : (k.fixed = !1, a(k.elm).removeClass("is-fixed"))
            }
        });
        a(document).on("add.cards delete.cards", function (b) {
            g && clearTimeout(g);
            g = setTimeout(function () {
                    k && (k.fixed = !1, a(k.elm).removeClass("is-fixed"));
    ...
    if (!e) {
        ...
        a(document).ready(function () {
            if (!a.isMobile() && a("input[name=animation]").length) {
                ...
                var d = a("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info").not(function () {
                ...
                e.on("scroll resize", function () {
                    var e = document.documentElement.scrollTop || document.body.scrollTop,
                        g = e + window.innerHeight - 100;
                    a.each(d, function () {
                        var d = a(this),
                            f = d[0],
                            h = f.offsetHeight;
                        f = c(f);
                        if ((f + h >= e && f <= g || b(d)) && d.hasClass("hidden")) d.removeClass("hidden").addClass("animate__fadeInUp animate__delay-1s").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
    ...
    if (!e && (0 < window.navigator.userAgent.indexOf("MSIE ") ||
        ...
        if (!e) {
            var b = function (b) {
                var c = a(b).parents("section").find("iframe")[0],
                    e = a(c).attr("src");
                b.parents("section").css("z-index", "5000"); - 1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*");
    ...
    if (!e && !a.isMobile()) {
        ...
        !m.find(".navbar").hasClass("collapsed") && 991 < q && (m.find("ul.navbar-nav li.dropdown").hover(function () {
    ...
    e || ("undefined" === typeof window.initClientPlugin && 0 != a(document.body).find(".clients").length && (window.initClientPlugin = !0, a(document.body).find(".clients").each(function (b, c) {
        a(this).attr("data-isinit") || (h(a(this)), f(a(this)))
...
! function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.in">Mobirise Simple Website Maker</a> Mobirise v5.2.0';
